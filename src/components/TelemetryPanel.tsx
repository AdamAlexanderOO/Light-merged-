...
export const TelemetryPanel: React.FC<TelemetryPanelProps> = ({
  ...
  if (!selectedStation) {
    return (
      <div className="w-full md:w-88 lg:w-96 xl:w-[410px] bg-[#04060a]/95 backdrop-blur-2xl border border-cyan-500/30 rounded p-5 text-cyan-400 font-mono text-xs shadow-2xl">
  ...
  return (
    <div 
      className="w-full md:w-88 lg:w-96 xl:w-[410px] bg-[#050505]/95 backdrop-blur-2xl border border-cyan-500/30 rounded-lg p-4 md:p-5 lg:p-6 flex flex-col justify-start text-slate-200 shadow-[0_0_30px_rgba(0,0,0,0.9)] shrink-0 font-sans select-none"
      style={{
    ...
    >
      <div>
        ...
        <div className="border-b border-cyan-500/20 pb-3 mb-4 flex items-center justify-between font-mono">
          <div className="flex items-center gap-2.5">
            <span className="w-2.5 h-2.5 rounded-xs bg-cyan-400 animate-pulse shadow-[0_0_8px_rgba(0,242,254,0.8)]" title="Active Telemetry Link" />
            <h2 className="text-xs lg:text-[13px] tracking-[0.2em] uppercase text-cyan-300 font-bold">
              OBSERVATION TARGET
            </h2>
          </div>
        ...
        {/* 2-Mode Tracking Bar */}
        <div className="grid grid-cols-2 gap-1.5 mb-4 bg-black/80 p-1.5 rounded border border-cyan-500/20 font-mono text-xs lg:text-[13px] shadow-inner">
          <button
            onClick={() => {
              if (onSelectTrackingMode) onSelectTrackingMode('auto');
              else if (onToggleAutoTrack && !isAutoTracking) onToggleAutoTrack();
            }}
            className={`py-2 px-2 rounded-xs font-bold transition-all flex items-center justify-center gap-1.5 ${
              trackingMode === 'auto'
          ...
          >
            ...
            <span className="truncate">AUTO ORBIT</span>
          </button>
          ...
          >
            ...
            <span className="truncate">FREE ROTATE</span>
          </button>
        </div>
        ...
        <div className="relative mb-5 group">
          <div className="w-full bg-black/80 border border-cyan-500/30 group-hover:border-cyan-400 transition-colors rounded px-4 py-3 flex items-center justify-between text-xs lg:text-sm font-mono text-slate-300 shadow-inner">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-3.5 mt-4 text-xs font-mono border-t border-cyan-500/20 pt-4">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[11px] lg:text-xs tracking-wider text-slate-400 uppercase font-medium">Eclipse Magnitude</span>
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[11px] lg:text-xs tracking-wider text-slate-400 uppercase font-medium">Solar Obscuration</span>
